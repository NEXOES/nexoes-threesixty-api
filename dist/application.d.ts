...
declare const NexoesThreesixtyApiApplication_base: (new (...args: any[]) => {
    [x: string]: any;
    projectRoot: string;
...
export declare class NexoesThreesixtyApiApplication extends NexoesThreesixtyApiApplication_base {
